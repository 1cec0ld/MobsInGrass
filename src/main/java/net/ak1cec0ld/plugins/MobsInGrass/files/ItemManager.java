    ...
    */
    ...
    private void initialize(){
        ...
        for(String eachPotion : items.getKeys(false)){
            ...
            String displayName = items.getString("displayname");
            if(displayName == null){
            ...
            Color color = items.getColor("color", null);
            if(color != null){
                item.setColor(color);
            }
            try {
                Material material = Material.valueOf(items.getString("material").toUpperCase());
